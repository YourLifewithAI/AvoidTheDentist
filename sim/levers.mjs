...
const levers = [
  ...
  ['Sweets as dessert with meals (vs snacks)', { withMeals: true }],
  ['Sugar-free gum after eating', { gum: true }],
  ...
  ['Acid reflux at night from 40', { phases: [{ age: 40, set: { reflux: true } }] }],
  ['Sleep apnea from 45, untreated', { phases: [{ age: 45, set: { sleepApnea: 'untreated' } }] }],
  ['Sleep apnea from 45, treated', { phases: [{ age: 45, set: { sleepApnea: 'treated' } }] }],
